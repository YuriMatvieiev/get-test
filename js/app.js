  ...
  (() => {
    ...
    function initSliders() {
      if (document.querySelector(".pricing__slider"))
        new swiper_core_Swiper(".pricing__slider", {
          slidesPerView: "auto",
          modules: [Mousewheel],
          spaceBetween: 40,
          autoHeight: false,
      ...
      function _createMessage() {
        ...
        function addActionsTo(element) {
          ...
          function addAction(element, action) {
            ...
            else button.onclick = _This.Close;
    ...
    if (typeof module !== "undefined")
      module.exports = js_snackbar_min_SnackBar;
    ...
    const initSection = function (sectionId, buttonClass, plan) {
      ...
      const locationAddressWrap = document.getElementById(
        "locationAddressWrap"
      );
      ...
      let confirmButtons = section.getElementsByClassName(
    ...
    function InitGeoForm(geocoderId, geocoderSectionId) {
      ...
      geoB.addEventListener("click", (e) => {
        ...
        if (
          ...
          document.getElementById("locationAddressWrap").style.display =
            "block";
          document.getElementById("locationAddressTitle").style.display =
            "block";
        }
      });
    }
